#!/usr/bin/env python3
"""Fix notebook 04 to use synthetic data - version 2 with simplified cell."""
import json
...
for cell in nb['cells']:
    if cell['cell_type'] == 'code':
        ...
        # Check if this is the cell with synthetic housing data
        if 'Synthetic housing price dataset' in source or 'fetch_california_housing()' in source:
            print("Found California Housing cell, replacing with simplified synthetic data...")

            # Replace with synthetic data generation (simplified)
