#!/usr/bin/env python3
"""
Execute remaining notebooks (17, 19, 20, 23, 25, 26, 28) after library installation completes
"""
...
def main():
    ...
    # Notebooks to execute after library installation
    notebook_numbers = [17, 19, 20, 23, 25, 26, 28]

    results = {}

    for num in notebook_numbers:
        notebook_path = notebooks_dir / f'{num:02d}_*.ipynb'
        ...
        # Use longer timeout for notebook 17 (Optuna optimization)
        timeout = 1200 if num == 17 else 900
